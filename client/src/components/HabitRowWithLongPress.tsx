    ...
    <React.Fragment>
      ...
      >
        <PopoverTrigger asChild>
          <motion.div 
            className="p-3 font-medium text-gray-800 dark:text-white truncate whitespace-nowrap text-left max-w-[88px] sm:max-w-[112px] md:max-w-[140px] cursor-default sm:cursor-auto"
