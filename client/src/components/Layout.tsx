    ...
    <div className="lg:grid lg:grid-cols-[220px_1fr] h-screen overflow-hidden">
      ...
      <div className="flex h-screen overflow-hidden lg:hidden safe-pad">
        <div className="flex-1 flex flex-col overflow-hidden">
          ...
          {/* Mobile Page Content */}
          <main className="flex-1 page-scroll p-4 sm:px-6 lg:px-8 xl:px-4 2xl:px-0 max-w-3xl md:max-w-4xl lg:max-w-6xl xl:max-w-7xl 2xl:max-w-[1600px] w-full overflow-x-hidden">
            <motion.div
              key={location}
