...
export default function MomentumChart({
  ...
  return (
    ...
    >
      ...
      {/* Mobile-only KPI cards above chart */}
      <div className="grid gap-3 grid-cols-2 mb-6 sm:hidden">
      ...
      {/* Mobile-only KPI cards below chart */}
      <div className="grid gap-3 grid-cols-2 mb-6 sm:hidden">
        <div className="bg-white/50 dark:bg-gray-800/50 rounded-xl p-4 text-center">
          <TooltipProvider>
            <Tooltip>
      ...
      <div className="hidden sm:grid gap-3 grid-cols-2 md:grid-cols-3">
        <div className="bg-white/50 dark:bg-gray-800/50 rounded-xl p-4 text-center">
          <div className="text-2xl font-bold text-blue-600 dark:text-blue-400">
            {todayRate >= 0 ? '+' : ''}{(todayRate * 100).toFixed(2)}%
          </div>
