      ...
      >
        <PopoverTrigger asChild>
          <motion.div
            ...
            style={{
              width: Math.min(Math.max(habit.goodHabit.length * 8 + 24, 80), 200) + 'px',
              minHeight: '44px',
              display: 'flex',
              alignItems: 'center'
            }}
          ...
          >
            <span className="text-xs sm:text-sm leading-snug overflow-wrap-anywhere">
              {habit.goodHabit}
            </span>
          </motion.div>
        </PopoverTrigger>
        <PopoverContent
          className="w-64 p-4 text-sm sm:hidden shadow-lg"
          side="right"
          align="start"
        >
          ...
          <div className="text-xs text-gray-500 dark:text-gray-400 mt-2">
            Long press to view full habit name
          </div>
        </PopoverContent>
      </Popover>
    ...
    >
      ...
      <div className="w-full overflow-x-hidden sm:overflow-x-auto">
        ...
        <div
          className="
            grid
            sm:grid-cols-[minmax(80px,_200px)_repeat(7,44px)]
            grid-cols-[minmax(80px,_160px)_repeat(7,40px)]
            gap-y-3
          ">
          {/* header row */}
